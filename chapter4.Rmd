...
*** =instructions
- Controlla che il codice costruisca un fattore utilizzando `vettore_sondaggio`. Dovresti usare `fattore_vettore_sondaggio` nell'istruzione successiva.
- Cambia i livelli di `fattore_vettore_sondaggio` da quelli attuali a `c("Female", "Male")`. Fai attenzione all'ordine degli elementi del vettore.
...
# no pec
vettore_sondaggio <- c("M", "F", "F", "M", "M")
fattore_vettore_sondaggio <- factor(vettore_sondaggio)
```
...
# Specifica i livelli di factor_vettore_sondaggio
levels(fattore_vettore_sondaggio) <- c("Female", "Male")
...
test_object("fattore_vettore_sondaggio", eq_condition = "equal",
            incorrect_msg = paste("Hai assegnato correttamente i livelli a `fattore_vettore_sondaggio`? Utilizza `levels(fattore_vettore_sondaggio) <- c(\"Female\", \"Male\")`. Ricorda che R è case sensitive!"))
