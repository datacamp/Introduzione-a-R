...
success_msg("Molto bene! Il grande vantaggio di fare i conti utilizzando le variabili &#233; la possibilit&#225; di riutilizzare il codice. Se assegnassi a `mie_mele` il valore 12 invece di 5 ed eseguissi nuovamente lo script, `mia_frutta` verrebbe aggiornata automaticamente. Procedi all'esercizio successivo.")
```
